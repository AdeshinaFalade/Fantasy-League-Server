...
const AuthContextErrorMap = {
  http: {
    UNAUTHORIZED: async (args) => new UnauthorizedException(
      args ?? {
        code: "UNAUTHORIZED",
        message: "Unauthorized"
      }
    ),
    FORBIDDEN: async (args) => new ForbiddenException(
      args ?? {
        code: "FORBIDDEN",
