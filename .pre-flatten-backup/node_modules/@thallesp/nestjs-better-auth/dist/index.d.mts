 ...
 */
interface UserHasPermissionOptions {
    /**
 ...
 * ```
 */
declare const UserHasPermission: (options: UserHasPermissionOptions) => CustomDecorator;
/**
 * Options for the MemberHasPermission decorator
 */
interface MemberHasPermissionOptions {
    /**
 ...
 * ```
 */
declare const MemberHasPermission: (options: MemberHasPermissionOptions) => CustomDecorator;
/**
 ...
 */
type DatabaseHookModel = "user" | "session" | "account" | "verification";
/**
 * The operations that support database hooks in Better Auth.
 */
type DatabaseHookOperation = "create" | "update" | "delete";
/**
 ...
 */
declare const BeforeCreate: (model: DatabaseHookModel) => CustomDecorator<symbol>;
/**
 * Registers a method to be executed after a record is created.
 * @param model - The model to hook into (user, session, account, verification)
 */
declare const AfterCreate: (model: DatabaseHookModel) => CustomDecorator<symbol>;
/**
 * Registers a method to be executed before a record is updated.
 * @param model - The model to hook into (user, session, account, verification)
 */
declare const BeforeUpdate: (model: DatabaseHookModel) => CustomDecorator<symbol>;
/**
 * Registers a method to be executed after a record is updated.
 * @param model - The model to hook into (user, session, account, verification)
 */
declare const AfterUpdate: (model: DatabaseHookModel) => CustomDecorator<symbol>;
/**
 * Registers a method to be executed before a record is deleted.
 * @param model - The model to hook into (user, session, account, verification)
 */
declare const BeforeDelete: (model: DatabaseHookModel) => CustomDecorator<symbol>;
/**
 * Registers a method to be executed after a record is deleted.
 * @param model - The model to hook into (user, session, account, verification)
 */
declare const AfterDelete: (model: DatabaseHookModel) => CustomDecorator<symbol>;
...
type BodyParserTypeMatcher = string | string[] | ((req: IncomingMessage) => unknown);
type BodyParserLimit = number | string;
interface CommonBodyParserOptions {
    inflate?: boolean;
    limit?: BodyParserLimit;
    type?: BodyParserTypeMatcher;
}
interface JsonBodyParserOptions extends CommonBodyParserOptions {
    reviver?: (key: string, value: unknown) => unknown;
    strict?: boolean;
}
interface UrlencodedBodyParserOptions extends CommonBodyParserOptions {
    extended?: boolean;
...
type AuthModuleJsonBodyParserOptions = JsonBodyParserOptions & {
    enabled?: boolean;
};
type AuthModuleUrlencodedBodyParserOptions = UrlencodedBodyParserOptions & {
    enabled?: boolean;
};
...
type AuthModuleMiddleware = (req: any, res: any, next: (error?: unknown) => void) => void | Promise<void>;
 ...
 * ```
 */
type UserSession<T = unknown> = T extends {
    $Infer: {
        Session: infer S;
    };
} ? S : BaseUserSession & {
...
declare const BEFORE_DATABASE_HOOK_KEY: symbol;
declare const AFTER_DATABASE_HOOK_KEY: symbol;

export { AFTER_DATABASE_HOOK_KEY, AFTER_HOOK_KEY, AUTH_MODULE_OPTIONS_KEY, AfterCreate, AfterDelete, AfterHook, AfterUpdate, AllowAnonymous, AuthGuard, AuthModule, AuthService, BEFORE_DATABASE_HOOK_KEY, BEFORE_HOOK_KEY, BeforeCreate, BeforeDelete, BeforeHook, BeforeUpdate, DATABASE_HOOK_KEY, DatabaseHook, HOOK_KEY, Hook, MemberHasPermission, Optional, OptionalAuth, OrgRoles, Public, Roles, Session, UserHasPermission };
export type { Auth, AuthHookContext, BaseUserSession, DatabaseHookModel, DatabaseHookOperation, MemberHasPermissionOptions, PermissionCheck, UserHasPermissionOptions, UserSession };
